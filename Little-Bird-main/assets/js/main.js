...
(function() {
  ...
  window.addEventListener('load', () => {
    ...
    var quotesArray = [
      'New Years Day - buy two wooden toys for 1 free item!!',
      'Martin Luther King Day - 25% off any toy vehicle',
      'Black Friday - 50% off for entire store',
      'Christmas - Buy one get one 50% off',
      'July 4th - 30% off one block toy set pack'
    ];
    ...
    var toys = document.getElementById('toys');
        ...
        document.getElementById('postcard').style.backgroundImage = 'url(assets/img/' + toys.value + '@4x.jpg)';
